...
class TvListNotifier extends ChangeNotifier {
  var _nowPlayinTvs = <Tv>[];
  List<Tv> get nowPlayinTvs => _nowPlayinTvs;
  ...
  TvListNotifier({
    required this.getNowPlayinTvs,
    required this.getPopularTvs,
    required this.getTopRatedTvs,
  });

  final GetNowPlayingTvs getNowPlayinTvs;
  ...
  Future<void> fetchNowPlayingTvs() async {
    ...
    final result = await getNowPlayinTvs.execute();
    result.fold(
      (failure) {
